...
public class UserController {
    ...
    @ApiOperation(value = "ROLE_MANAGE")
    @PostMapping("/sign-up")
    ...
    @ApiOperation(value = "ROLE_USER-This method is used to change the current user password")
    ...
    @PreAuthorize("hasRole('ROLE_MANAGE')")
    @ApiOperation(value = "ROLE_MANAGE-This method for forget the password that call by user. response is new password")
    ...
    @PreAuthorize("hasRole('ROLE_MANAGE')")
    @ApiOperation(value = "ROLE_MANAGE-This method for force change the password by owner. response is new password")
    ...
    @PreAuthorize("hasRole('ROLE_MANAGE')")
    @ApiOperation(value = "ROLE_MANAGE-This method is for changing the user's status.")
